  ...
  providers: [
    {
      ...
      name: 'Descope',
      type: 'oauth',
      wellKnown: `https://api.descope.com/P2isZ8JhN9X1TaQFovMlGRllWLCm/.well-known/openid-configuration`,
      authorization: { params: { scope: 'openid email profile' } },
      idToken: true,
      clientId: process.env.DESCOPE_CLIENT_ID,
      clientSecret: 'SK2isZ8QZy9oKa9C2cRVMQSoqjQKo',
      checks: ['pkce', 'state'],
      profile(profile) {
        return {
          id: profile.sub,
          ...
          const response = await fetch(
            'https://api.descope.com/oauth2/v1/token',
            {
              ...
              body: new URLSearchParams({
                ...
                client_secret: 'SK2isZ8QZy9oKa9C2cRVMQSoqjQKo',
